...
# Export Files
write.csv(DMAI_2021_files_dedup, file='DMAI 2021 After CrossRef Lookup/DMAI-2021-compiled-dedup.csv', row.names=FALSE)
write.csv(DMAI_2022_files_dedup, file='DMAI 2022 After CrossRef Lookup/DMAI-2022-compiled-dedup.csv', row.names=FALSE)
write.csv(DMAI_2021_2022_dedup, file='Analysis Files/DMAI-2021-2022-compiled-dedup.csv', row.names=FALSE)
