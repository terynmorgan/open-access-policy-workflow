...
#write.csv(scopus_dedup_2021, "Scopus/V4_results_20240126/Scopus_2021_Results_20240126.csv", row.names = FALSE)
#write.csv(scopus_dedup_2022, "Scopus/V4_results_20240126/Scopus_2022_Results_20240126.csv", row.names = FALSE)
#write.csv(scopus_dedup, "Scopus/V4_results_20240126/Scopus_2021_2022_Results_20240126.csv", row.names = FALSE)
